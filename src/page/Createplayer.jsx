...
const Createplayer = () => {
  ...
  const items = [
    ...
    { label: "ฟุตซอล", path: "/createplayer", icon: playerfutsal },
    { label: "บาสเก็ตบอล", path: "/createcoach", icon: playerbasketball },
    { label: "วอลเลย์บอล", path: "/createteam", icon: playervolleyball },
    { label: "เทเบิลเทนิส", path: "/createteam", icon: playertabletenis },
    { label: "เปตอง", path: "/createteam", icon: playerpetanque },
    { label: "แบตมินตัน", path: "/createteam", icon: playerbadminton },
    { label: "เซปักตะกร้อ", path: "/createteam", icon: playertakraw },
    { label: "ตะกร้อลอดห่วง", path: "/createteam", icon: hooptakraw },
