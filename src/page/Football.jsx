      ...
      <Card variant="outlined" sx={{ mt: 4 }}>
        <CardContent>
          ...
          <form onSubmit={handleSubmit} style={{ width: "100%" }}>
            ...
            />
            {/* <FormControl fullWidth margin="normal" required>
              <InputLabel id="sporttypes">ประเภทกีฬา</InputLabel>
              <Select
                labelId="sporttypes"
                name="sporttypes"
                value={playerData.sporttypes}
                onChange={handleChange}
              >
                {sportTypes.map((sportType) => (
                  <MenuItem
                    key={sportType.sporttypes_id}
                    value={sportType.sporttypes_name} // Use sport type name as value
                  >
