...
const Badmintonpage = () => {
  ...
  const items = [
    { label: "แบตมินตันชาย", path: "/badmintonmen", icon: singlemen },
    { label: "แบตมินตันหญิง", path: "/badmintonwomen", icon: singlewomen },
    { label: "แบตมินตันผสม", path: "/badmintonmix", icon: playermix },
  ];
